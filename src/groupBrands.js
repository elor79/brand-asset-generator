...
//
// Medartis Group is not that. medartis, NeoOrtho and KeriMedical are OWNED. There
// is no relation to declare, because the relation is the logo: they are the Group.
...
export const SUB_BRANDS = {
  medartis: {
    label: 'medartis',
    mark: null,                       // the house wordmark; the engine already owns it
    colors: { primary: '#131310' },   // coal — medartis is monochrome by definition
    note: 'The founding brand. Monochrome: it has no colour of its own to lend.',
  },
  neoortho: {
    label: 'NeoOrtho',
    mark: 'NEOORTHO_MARK',
